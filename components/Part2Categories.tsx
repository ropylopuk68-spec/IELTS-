      ...
      <div className="max-w-6xl mx-auto w-full">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-5">
                ...
                <div className="w-24 h-24 rounded-full bg-white/80 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                  <span className="text-5xl leading-none flex items-center justify-center">{category.emoji}</span>
                </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl shadow-md border border-purple-200 overflow-hidden">
          ...
          <button
            ...
            className="w-full px-6 py-4 flex items-center justify-between hover:bg-purple-100/50 transition-colors text-left"
          >
            ...
            <div className="px-6 pb-6 space-y-4 text-gray-700 text-base">{/* 增大文字 */}
              ...
              <div>
                ...
                <div className="ml-4 space-y-2">
                  ...
                  <p className="leading-relaxed">
                    由于Part 2不断有新题出现 <span className="font-medium text-purple-600">串题故事</span>也暂不稳定  需要根据新题随时修改
                  </p>
              ...
              {/* 2. 串题注意事项 */}
              <div>
                <h4 className="font-bold text-black mb-2">2. 串题注意事项</h4>
                <div className="ml-4 space-y-2">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-purple-600">-</span>
                      <span>题目名称列内 <span className="font-medium text-purple-600">多个方框同一色彩</span> 代表互相串题 共用素材</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-purple-600">-</span>
                      <span><span className="font-medium text-purple-600">串题</span>这种形式优点是<span className="font-medium text-purple-600">备考压力小</span>，但缺点不可避免有<span className="font-medium text-purple-600">主题不唯一/素材堆砌</span>的情况<br />
                      大家考场上根据抽到的题目灵活使用素材 [eg:跳过/省略说不相关的主题 重点说你抽到的]</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-purple-600">-</span>
                      <span>串题但主题方向差别大的题目 需要单独在<span className="font-medium text-purple-600">开头句</span>根据不同题目先扣题 [尤其<span className="font-medium text-purple-600">事件事物类</span>]</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              {/* 3. 回答补充内容 */}
              <div>
                <h4 className="font-bold text-black mb-2">3. 回答中标有 [  ] 表示补充内容</h4>
                <p className="ml-4 leading-relaxed">
                  可根据能力/目标分数选择性学习 <span className="font-medium text-purple-600">不说不影响核心回答</span>
                </p>
              </div>
            </div>
          </div>
