      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <button
            ...
            className="group relative inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-400 via-purple-500 to-pink-400 text-white rounded-2xl font-bold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
          >
            <span className="text-2xl">🎯</span>
            <span>开始全真模考</span>
            <span className="text-sm font-normal opacity-90">Mock Exam</span>
          </button>
        </div>
